    ...
    <div className="background--home">
      <div className="scroll-area--home">
        <div className="content--home">
                <p className="new-info-header--home">Nya viktig info</p>
...
Pris: 100 kr/person. För att boka plats på en buss: Smsa Maja på 076-2557990 senast 19/7. Bussarna kör in till centrala Västerås (ej hem till dörren).</p>
                <p className="new-info-text--home">
